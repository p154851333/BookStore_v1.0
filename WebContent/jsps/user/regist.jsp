...
<html>
  <head>
    ...
    <title>DarlingMonkey网上书城|注册</title>
	...
	function _change(){
		...
		*/
		...
		img.src="<c:url value='/UserServlet'/>?method=VerifyCodeChange&a=" + new Date().getTime();
	}
  ...
  <body>
	  ...
	  <div id="divwai">
		...
		<form action="<c:url value='/UserServlet' />" method="post">
			...
			邮　箱：<input type="text" name="email" value="${formUser.email }"/><font style="color: red">${errors.email }</font><br/>
			验证码：<input type="text" name="verifycode" value="" size="3" />
					<img src="<c:url value='/UserServlet'/>?method=VerifyCodeChange" id="img"/>

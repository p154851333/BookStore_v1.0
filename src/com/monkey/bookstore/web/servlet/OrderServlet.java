...
import com.monkey.bookstore.service.OrderException;
...
public class OrderServlet extends BaseServlet {
	...
	public  String addOrder(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (cart.getCartItmes()==null||cart.getCartItmes().toString() =="[]") {
	...
	public  String myOneOrder(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//得到页面上传来的oid
	...
	* @date		2017年3月29日 下午2:08:24
	 */
	public  String confirmGoods(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/*
		 * 1.从页面得到订单的oid
		 * 2.提交给业务层修改状态码。
